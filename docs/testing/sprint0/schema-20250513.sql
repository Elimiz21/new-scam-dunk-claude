...
\restrict m8ak8Ak4Z4waphTV3Vc7WE3OhgDGcATkynY5F1lICAGwif2DwMjFRmbtb9oa6zL
...
CREATE TABLE public.contact_verifications (
    ...
    is_scammer boolean DEFAULT false NOT NULL,
...
--
-- Name: api_keys api_keys_key_name_key; Type: CONSTRAINT; Schema: public; Owner: -
--
...
CREATE INDEX idx_api_keys_name ON public.api_keys USING btree (key_name);


--
-- Name: idx_contact_verifications_user; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_contact_verifications_user ON public.contact_verifications USING btree (user_id);


--
-- Name: idx_contact_verifications_value; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_contact_verifications_value ON public.contact_verifications USING btree (contact_value);
...
--
-- Name: scans set_scans_updated_at; Type: TRIGGER; Schema: public; Owner: -
--
...
--
-- Name: contact_verifications contact_verifications_user_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.contact_verifications
    ADD CONSTRAINT contact_verifications_user_id_fkey FOREIGN KEY (user_id) REFERENCES public.users(id) ON DELETE SET NULL;
...
ALTER TABLE ONLY public.scans
    ADD CONSTRAINT scans_user_id_fkey FOREIGN KEY (user_id) REFERENCES public.users(id) ON DELETE SET NULL;
...
--
-- Name: TABLE contact_verifications; Type: ACL; Schema: public; Owner: -
--
...
--
-- Name: TABLE scans; Type: ACL; Schema: public; Owner: -
--
...
\unrestrict m8ak8Ak4Z4waphTV3Vc7WE3OhgDGcATkynY5F1lICAGwif2DwMjFRmbtb9oa6zL
