...
const CONTACT_ROUTE = '**/api/contact-verification'
const CHAT_ROUTE = '**/api/chat-analysis'
const TRADING_ROUTE = '**/api/trading-analysis'
const VERACITY_ROUTE = '**/api/veracity-checking'
